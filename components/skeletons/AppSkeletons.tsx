...
export function AuditSkeleton() {
    return (
        <div className="space-y-6 pb-20 md:pb-0 animate-in fade-in duration-500">
            ...
            {/* Summary Cards Skeleton (Mimic In Progress State) */}
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                {[1, 2].map((colIndex) => (
                    <div key={colIndex} className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden h-[500px] flex flex-col">
                        ...
                        <div className="flex-1 p-0">
                            {[1, 2, 3, 4, 5].map((i) => (
                                <div key={i} className="flex items-center justify-between border-b border-slate-100 px-6 py-4 last:border-0">
